...
// ดึงรายการหมวดหมู่ (categories) เพื่อแสดงใน dropdown
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['csrf_token']) || !verifyCsrfToken($_POST['csrf_token'])) {
        ...
        // ถ้าไม่มี error เบื้องต้น
        if (empty($errors)) {
            // Insert ข้อมูลต้นไม้ใหม่ (died, sold ตั้งค่าเป็น 0)
            ...
            try {
                ...
                // ถ้ามีไฟล์ภาพ ให้สร้างโฟลเดอร์ uploads/trees/<newTreeId> แล้วย้ายไฟล์ไป
                if ($uploadedFiles && isset($uploadedFiles['name']) && is_array($uploadedFiles['name'])) {
                    ...
                    for ($i = 0; $i < count($uploadedFiles['name']); $i++) {
                        if ($uploadedFiles['error'][$i] === UPLOAD_ERR_OK) {
                            ...
                            if (move_uploaded_file($tmpName, $destination)) {
                                // บันทึก URL ลงตาราง tree_images (ใช้ path แบบ relative เมื่อเรียกดูจาก frontend)
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= e(basename($_SERVER['PHP_SELF'])) ?>" method="post" enctype="multipart/form-data" novalidate class="needs-validation">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        value="<?= e($size) ?>"
                                        required
                                        placeholder="เช่น กระถาง 6 นิ้ว, สูง 30 ซม.">
                            ...
                            <div class="card bg-light border p-3">
                                <div class="file-upload-wrapper">
                                    <label for="images" class="d-block mb-3 text-center">
                                        <div class="upload-area p-5 bg-white rounded border-2 border-dashed d-flex flex-column align-items-center justify-content-center" id="drop-area" style="cursor: pointer; border-style: dashed;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFileSelect() {
        ...
        Array.from(fileInput.files).forEach(file => {
            ...
            // Create card body with filename
    ...
    // Allow clicking anywhere in the upload area to trigger file selection
